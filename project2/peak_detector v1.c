...
volatile float rms_voltage_left = 0;
volatile float rms_voltage_right = 0;
...
void main (void)
{
	...
	while(1)
	{
		...
		rms_voltage_left = (V[0]/1.4142)*1000;		
		rms_voltage_right = (V[1]/1.4142)*1000;	
		
		printf("L RMS V=%3.3f mV, R RMS V=%3.3f mV   \r",rms_voltage_left, rms_voltage_right);
		waitms(100);	
	}//end while
}//end main