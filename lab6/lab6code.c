...
void main (void)
{
	...
	PWM_2 = 0;
	printf(GOTO_YX, 1,1);
	printf("Choose between two options: temperature controlled motor (1), or user-controlled motor (other): ");
	scanf("%d\n", &selection);
	...
	while (selection==1)
	{
		...
		DRV=((voltage-2.93)/0.05)*100;
		printf("\rvoltage: %.3f, DRV: %d        ", voltage, DRV);
		PWM_1 = DRV;
		PWM_2 = 0;
